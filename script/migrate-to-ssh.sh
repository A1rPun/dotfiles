#!/bin/bash
# Source: https://stackoverflow.com/a/78269270
# Usage:
# find . -type d \( -name "node_modules" -o -name ".worktrees" \) -prune -o -name ".git" -print \
#   -exec sh -c 'echo "Subdir: $0" && cd "$0/.." && $HOME/../migrate-to-ssh.sh; echo' {} \;
